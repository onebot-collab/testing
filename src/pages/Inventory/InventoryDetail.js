...
class InventoryDetail extends Component {
  ...
  render() {
    ...
    const slideImages = [
      `${process.env.REACT_APP_URL}${this.props.location.state.image_url}?boAgRwlfX5=${this.props.login.token}`,
      `${process.env.REACT_APP_URL}${this.props.location.state.image_url2}?boAgRwlfX5=${this.props.login.token}`,
      `${process.env.REACT_APP_URL}${this.props.location.state.image_url3}?boAgRwlfX5=${this.props.login.token}`,
    ]
    return (
      <div>
        <GridContainer>
              ...
              <CardBody>
                      ...
                      <Slide>
                        <div className="each-slide">
                          <img
                            ...
                            src={`${process.env.REACT_APP_URL}${this.props.location.state.image_url}?boAgRwlfX5=${this.props.login.token}`}
                            alt="inventory img"
                          />
                        </div>
                        <div className="each-slide">
                ...
                <div className="d-flex flex-row justify-content-between pt-3">
                  ...
                  <div className="d-flex flex-fill p-2">
                    <a
                      target="_blank"
                      href={`${process.env.REACT_APP_URL}${this.props.location.state.codeQr}?boAgRwlfX5=${this.props.login.token}`}
                      className="btn btn-block btn-outline-danger"
                    >
                      QR Code
                    </a>
